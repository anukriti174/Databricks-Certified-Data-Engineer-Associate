...
# dbutils.fs.rm("dbfs:/Volumes/zenogroup/default/fileupload/Stryker/StrykerAlliancecampaign/", recurse=True)
...
#Deleting a file from Strykerdata
#rm-rf /Volumes/zenogroup/default/fileupload/Stryker/StrykerAlliancecampaign/
